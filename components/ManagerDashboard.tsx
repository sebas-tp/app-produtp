...
import { 
  ...
  PenTool, Database // <--- AGREGADOS PARA EL BOTÓN DE MANTENIMIENTO
} from 'lucide-react';
...
export const ManagerDashboard: React.FC = () => {
  ...
  return (
    <div className="space-y-6 p-4 md:p-8 pb-20">
      {/* HEADER - AQUÍ YA NO ESTÁ EL BOTÓN PELIGROSO */}
      ...
      {/* RESTO DE TABS (MÉTRICAS, EFICIENCIA, ETC.) - IDÉNTICO AL ORIGINAL */}
      {/* ... PESTAÑA 1: MÉTRICAS ... */}
      {activeTab === 'metrics' && (
      ...
      {/* PESTAÑA 2: EFICIENCIA (IDÉNTICO AL ORIGINAL) */}
      ...
      {/* PESTAÑA 3: AUDITORÍA (IDÉNTICO AL ORIGINAL) */}
      {activeTab === 'audit' && (
        <div className="animate-in fade-in space-y-6">
      ...
      {/* PESTAÑA 4: CONTABILIDAD (IDÉNTICO AL ORIGINAL) */}
      ...
      {/* PESTAÑA 5: SIMULADOR (IDÉNTICO AL ORIGINAL) */}
      {activeTab === 'simulator' && (
        <div className="animate-in fade-in space-y-6">
            ...
            <div className="flex-1 overflow-y-auto p-8 bg-slate-50">
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 h-full">
                ...
                <div className="space-y-6">
                  {/* SECCIÓN MANTENIMIENTO DB (NUEVA: EL BOTÓN SEGURO) */}
                  <div className="bg-purple-50 p-6 rounded-xl shadow-sm border border-purple-200">
                    ...
                    >
                      <PenTool className="w-4 h-4"/> CORREGIR MODELOS
                    </button>
                  </div>
